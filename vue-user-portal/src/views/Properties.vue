    ...
    <div class="container">
      <div class="section-intro text-center pb-80px">
        <div class="section-intro__style">
          <img src="/src/assets/home/bed-icon.png" alt="">
        </div>
      ...
      <div class="row pb-4">
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="/src/assets/home/explore1.png" alt="">
            </div>
            <div class="card-body">
              <h3 class="card-explore__price">$150.00 <sub>/ Per Night</sub></h3>
              <h4 class="card-explore__title"><router-link to="#">Classic Bed Room</router-link></h4>
              <p>Beginning fourth dominion creeping god was. Beginning, which fly yieldi dry beast moved blessed </p>
              <router-link class="card-explore__link" to="#">Book Now <i class="ti-arrow-right"></i></router-link>
            </div>
          </div>
        </div>
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="/src/assets/home/explore2.png" alt="">
            </div>
            <div class="card-body">
              <h3 class="card-explore__price">$170.00 <sub>/ Per Night</sub></h3>
              <h4 class="card-explore__title"><router-link to="#">Premium Room</router-link></h4>
              <p>Beginning fourth dominion creeping god was. Beginning, which fly yieldi dry beast moved blessed </p>
              <router-link class="card-explore__link" to="#">Book Now <i class="ti-arrow-right"></i></router-link>
            </div>
          </div>
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="/src/assets/home/explore3.png" alt="">
            </div>
            <div class="card-body">
              <h3 class="card-explore__price">$190.00 <sub>/ Per Night</sub></h3>
              <h4 class="card-explore__title"><router-link to="#">Family Room</router-link></h4>
              <p>Beginning fourth dominion creeping god was. Beginning, which fly yieldi dry beast moved blessed </p>
              <router-link class="card-explore__link" to="#">Book Now <i class="ti-arrow-right"></i></router-link>
            </div>
          </div>
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="/src/assets/home/explore4.png" alt="">
            </div>
            <div class="card-body">
              <h3 class="card-explore__price">$120.00 <sub>/ Per Night</sub></h3>
              <h4 class="card-explore__title"><router-link to="#">Single Bed Room</router-link></h4>
              <p>Beginning fourth dominion creeping god was. Beginning, which fly yieldi dry beast moved blessed </p>
              <router-link class="card-explore__link" to="#">Book Now <i class="ti-arrow-right"></i></router-link>
            </div>
          </div>
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="/src/assets/home/explore5.png" alt="">
            </div>
            <div class="card-body">
        ...
        <div class="col-md-6 col-xl-4 mb-5">
          <div class="card card-explore">
            <div class="card-explore__img">
              <img class="card-img" src="/src/assets/home/explore6.png" alt="">
            </div>
            <div class="card-body">
              <h3 class="card-explore__price">$150.00 <sub>/ Per Night</sub></h3>
              <h4 class="card-explore__title"><router-link to="#">Family Room</router-link></h4>
